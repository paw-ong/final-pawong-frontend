...
export default function LostAnimalUpdate() {
  ...
  return (
    <div className="lost-animal-write-container">
      <div className="lost-animal-create-title-header">
        ...
        <span className="lost-animal-create-title-text">실종 동물 공고 수정하기</span>
        <PrimaryButton type="submit" form="lost-animal-update-form">수정하기</PrimaryButton>
      </div>
      {uploading && <LoadingSpinner />}
      <form onSubmit={handleSubmit} className="lost-animal-write-form" id="lost-animal-update-form">
